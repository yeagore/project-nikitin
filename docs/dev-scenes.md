...
bank, overhang, beach, ford, Gate landing, ferry quay, summit) and the five
habitat axes as ramps: `moisture`, `warmth`, `rugged`, `exposure`, `rim`. Water
is coloured by kind (ford, stream, navigable reach, lake) and goo is violet in
every view.
...
the prevailing wind along each dune field, and two bounding boxes: the faint cube
of the Domain (nothing the generator builds may hang outside it) and a gold box
tight round the landmass.
...
reach shares, shelves, berths, rivers, Gates, and what each road out costs.
